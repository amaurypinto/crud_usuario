<div class="app-menu">
    <div class="logo-box">
        ...
        <a href="index.html" class="logo-light">
            <img src="https://tecnicadecimo.files.wordpress.com/2016/01/sena.png" alt="logo" class="logo-lg">
            <img src="https://tecnicadecimo.files.wordpress.com/2016/01/sena.png" alt="small logo" class="logo-sm">
        </a>
